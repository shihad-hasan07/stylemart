export default function Hero_swipeer_product_loading() {
    return (
        <div className='pb-10  overflow-hidden animate-pulse grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10'>
